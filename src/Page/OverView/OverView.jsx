  ...
  return (
    <div className="py-6 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Attendance Summary */}
        <div className="bg-white shadow rounded-lg p-4 flex items-center">
          <FaClipboardList className="text-yellow-600 text-4xl mr-4" />
          <div>
        ...
        {/* Fee Collection */}
        <div className="bg-white shadow rounded-lg p-4 flex items-center">
          <FaMoneyCheckAlt className="text-purple-600 text-4xl mr-4" />
          <div>
        ...
        {/* Library Stats */}
        <div className="bg-white shadow rounded-lg p-4 flex items-center">
          <FaBook className="text-red-600 text-4xl mr-4" />
          <div>
            <h2 className="text-xl font-semibold">Library Books</h2>
            <p className="text-gray-600">1,500 Available</p>
          </div>
        </div>

        {/* Upcoming Events */}
        <div className="bg-white shadow rounded-lg p-4 flex items-center">
          <MdEvent className="text-indigo-600 text-4xl mr-4" />
          <div>
            <h2 className="text-xl font-semibold">Upcoming Events</h2>
            <p className="text-gray-600">Science Fair: 3 Days Left</p>
          </div>
        </div>
      </div>

      {/* Performance Graph */}
      <div className="mt-8 bg-white flex justify-around shadow rounded-lg p-6">
